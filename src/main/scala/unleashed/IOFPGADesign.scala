...
import sifive.nvdla_blocks.devices.nvdla._
...
class IOFPGADesign()(implicit p: Parameters) extends LazyModule with BindingScope
{
  ...
  lazy val prelude = io.Source.fromFile("bootrom/AloeConfig.dts").mkString
  ...
  val pcieAddrs = Seq(
    (0x2c00000000L, Seq(AddressSet(0x2000000000L, 0x3ffffffffL), AddressSet(0x40000000, 0x1fffffff))),
    (0x2d00000000L, Seq(AddressSet(0x2400000000L, 0x3ffffffffL))),
